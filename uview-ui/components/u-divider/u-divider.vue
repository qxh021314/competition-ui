<template>
	<view class="u-divider" :style="{
		...
		}"><slot /><u-icon v-if="!showright && !showup" name="arrow-down-fill" color="#909399" size="25"></u-icon></view>
	   
		<view v-if="showright" class="u-divider-line" :class="[type ? 'u-divider-line--bordercolor--' + type : '']" :style="[lineStyle]"></view>
	</view>
</template>

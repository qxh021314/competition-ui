...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"competition-ui","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/pages.json ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!************************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/httpRequest/request.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _index = _interopRequireDefault(__webpack_require__(/*! ../utils/index.js */ 12));
var _index2 = _interopRequireDefault(__webpack_require__(/*! ../store/index.js */ 16));
var _userService = _interopRequireDefault(__webpack_require__(/*! ../utils/userService.js */ 19));
var _index3 = _interopRequireDefault(__webpack_require__(/*! ../config/index.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                   * 请求接口进行封装处理
                                                                                                                                                                   * @author wdd.
                                                                                                                                                                   **/var loginLock = false;var $http = {
  /**
                                                                                                                                                                                                           * 请求数据处理
                                                                                                                                                                                                           ...
                                                                                                                                                                                                           *  false:显示
                                                                                                                                                                                                           */
  request: function request(url, method, postData) {var isJson = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;var hideLoading = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    //接口请求
    var loadding = false;
    ...
    var toUrl = _index3.default.interfaceUrl() + url;
    ...
    return new Promise(function (resolve, reject) {
      uni.request({
        ...
        header: {
          ...
          'token': _userService.default.getToken() },
        ...
        success: function success(res) {
          ...
          if (res.data.code == 406 && !loginLock) {
            loginLock = true;
            _index.default.modal('提示', "您还未登录，是否前往登录", true, function (result) {
              if (result) {
                uni.navigateTo({
          ...
          if (res.data.code == 0) {
            ...
            _index.default.toast("登录信息已失效!");
          } else {
            _index.default.toast(res.data.msg);
          }
        },
        fail: function fail(res) {
          // clearTimeout($utils.delayed)
          // $utils.delayed = null;
          _index.default.toast("网络不给力，请稍后再试~");
          reject(res);
        } });
  ...
  /**
      ...
      */
  uploadFile: function uploadFile(url, path) {
    uni.showLoading({
      title: '请稍候...' });

    var url = _index3.default.interfaceUrl() + url;
    return new Promise(function (resolve, reject) {
      console.log(url);
  ...
  payOrder: function payOrder(orderId) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      then(function (res) {
        console.log(res);
        if (res.code === 0) {
          var appOrderResult = res.appOrderResult;
          uni.requestPayment({
            provider: 'wxpay',
            orderInfo: {
...
/* 12 */
/*!****************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/utils/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var $utils = {
  ...
  /**
      * 获取当前时间
      */
  getDate: function getDate(type) {var dayNum = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    var date = new Date();
  ...
  toast: function toast(text, mask, duration, success) {
    uni.showToast({
      title: text || "服务异常",
  ...
  filter: function filter(array) {
    return array.filter(function (item) {return !$utils.isEmpty(item);});
  },
  ...
  /**
      ...
      * @param {Object} lists
      */
  deepRetrieval: function deepRetrieval(modelList, list) {
    console.log(modelList.map(function (item) {
      console.log(item);
    }));
  },
  /**
  ...
  modal: function modal(title, content, showCancel, callback, cancelText, confirmColor, confirmText) {
    uni.showModal({
      title: title || '提示',
      content: content,
  ...
  /**
      ...
      * @param {Object} key
      */
  totalizer: function totalizer(list, key, num) {
    var result = 0;
  ...
  /**
      ...
      */
  isPassword: function isPassword(text) {
  ...
  /**
      ...
      */
  isVerificationCode: function isVerificationCode(text) {
    if (/^\d{6}$/.test(text)) {
      return true;
    }
    return false;
  ...
  /**
      ...
      */
  isGroupCode: function isGroupCode(text) {
    if (/^\d{8}$/.test(text)) {
      return true;
    }
    return false;
  ...
  /**
      ...
      */
  isGroupName: function isGroupName(text) {
  ...
  /**
      * 上传图片
      */
  uploadImage: function uploadImage(count, header) {var _this = this;
    uni.chooseImage({
      count: count, //默认9
  ...
  /**
      ...
      */
  imageTobase64: function imageTobase64(url, _success2) {var _this2 = this;
  ...
  // 判断是否为空值: 
  isNotBlank: function isNotBlank(val) {
  ...
  /**
      ...
      * @param {Array} keys
      */
  isNotEmpty: function isNotEmpty(obj, keys) {
    var isParams = true;
  ...
  removeEmptyField: function removeEmptyField(list) {
  ...
  removeNull: function removeNull(data) {var defaultStr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '--';
    // 普通数据类型
...
/* 16 */
/*!****************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/store/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _sys = _interopRequireDefault(__webpack_require__(/*! ./modules/sys.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

_vue.default.use(_vuex.default);

var store = new _vuex.default.Store({
  modules: {
    sys: _sys.default } });var _default =
...
/* 18 */
/*!**********************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/store/modules/sys.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var user = {
  ...
  mutations: {
    SET_ADDR_LIST: function SET_ADDR_LIST(state, addrList) {
      state.addrList = addrList;
    },
    SET_IS_REQUEST: function SET_IS_REQUEST(state, isRequest) {
...
/* 19 */
/*!**********************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/utils/userService.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var $userService = {
  // 设置用户信息缓存
  ...
  setUserEncryInfo: function setUserEncryInfo(userEncryInfo) {
    uni.setStorage({
      data: userEncryInfo,
      key: 'userEncryInfo' });

  },
  getUserEncryInfo: function getUserEncryInfo() {
  ...
  // 设置协议阅读状态
  setReadStatus: function setReadStatus(readStatus) {
    uni.setStorage({
      key: 'readStatus',
      data: readStatus });
...
/* 20 */
/*!*****************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/config/index.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 21 */
/*!***************************************************************!*\
  !*** /Users/fx/WebstormProjects/competition-ui/utils/code.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var code = {
  BANNER_POSITION: {
    index_online_class_top: 'index_online_class_top', // 首页课堂banner
    index_online_class_pop: 'index_online_class_pop', // 在线课堂弹窗
    index_enterprise_zone_top: 'index_enterprise_zone_top', // 企业专区上方
    index_offline_activity_top: 'index_offline_activity_top', // 线下活动上方
    course_more_course: 'course_more_course', // 更多课程
    mall_Top: 'mall_top' // 视界
  },
  MENU_CODE: {
    enterpriseZone: 'enterpriseZone',
    offlineActivity: 'offlineActivity' },

  SYS_DICT: {
    COMPANY_SCALE: 'COMPANY_SCALE', // 企业规模
    INDUSTRY: 'INDUSTRY', // 所属行业
    SALE_AFTER_TYPE: 'SALE_AFTER_TYPE', // 售后类型
    RETURN_REASON: 'RETURN_REASON', // 退货理由
    RETURN_WAY: 'RETURN_WAY' // 退货方式
  } };var _default =
